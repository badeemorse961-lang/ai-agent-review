...
class DesktopAppService:
    def get_projection(self, workspace_root: str) -> DesktopProjection:
        ...
        return DesktopProjection(
            ...
            validation_verdict=None,  # explicitly None per design: no authoritative validation result read contract
            ...
            git_dirty_state=tuple(git_info.get("dirty_state")) if isinstance(git_info, dict) and git_info.get("dirty_state") else None,
