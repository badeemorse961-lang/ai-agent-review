...
This milestone does not add repository mutation authority. It closes a race and strengthens identity evidence inside the already promoted boundary.
...
Regression coverage was added for lock ordering, HEAD advancement, and resolved-HEAD consistency.
